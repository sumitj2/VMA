    ...
    public class PaymentsViewModel : ViewModelBase
    {
        ...
        private async Task GetVendorPayments()
        {
            try
            {
                ...
                VendorsPayment = TempVendorsPayment = new ObservableCollection<VendorPaymentModel>(vendorsPayment.OrderByDescending(x=>x.CreatedDate).ThenByDescending(x=>x.LastUpdatedDate));
