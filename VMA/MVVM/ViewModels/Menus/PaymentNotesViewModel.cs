    ...
    public class PaymentNotesViewModel : ViewModelBase
    {
        ...
        private async Task GetPaymentsNote()
        {
            try
            {
                ...
                VendorPaymentNotes = TempVendorPaymentNotes = new ObservableCollection<VenderPaymentNoteModel>(paymentNotes.OrderByDescending(x=>x.CreatedDate).ThenByDescending(x=>x.LastUpdatedDate));
